...
//    bool areTheSpritesColliding(CCSprite* spr1, CCSprite* spr2, bool pp, CCRenderTexture* _rt);
    unsigned int areTheSpritesColliding(CCSprite* spr1, CCSprite* spr2, bool pp, CCRenderTexture* _rt);
    bool areTheSpritesCollidingFast(CCSprite* spr1, CCSprite* spr2, bool pp, CCRenderTexture* _rt);
